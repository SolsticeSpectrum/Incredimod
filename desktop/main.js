...
app.textlist = {
    "txt.quitAppConfirm": "Do you really want to quit Incredimod?",
    "bt.quit": "Quit",
    "bt.cancel": "Cancel"
}, app.name = "Incredimod", app.on("ready", createWindow), app.on("window-all-closed", function() {}), app.on("before-quit", () => {
    app.quitting = !0
